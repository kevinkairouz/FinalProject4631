async function fetchData(){   
    ...
    let prediction = await fetch("http://127.0.0.1:5000/predictGB",{method: "POST", headers: {"Content-type": "application/json"}, body: JSON.stringify(obj)}) 
...
async function fetchData2(){
    ...
    let prediction = await fetch("http://127.0.0.1:5000/predictNN",{method: "POST", headers: {"Content-type": "application/json"}, body: JSON.stringify(obj)}) 
    let data = await prediction.json()
    console.log(data); 
    return "SUCCESS"; 
